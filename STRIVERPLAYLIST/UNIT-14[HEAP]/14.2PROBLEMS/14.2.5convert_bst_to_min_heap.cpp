...
// convert BST to Min heap such that all the elements in the left is smaller than right and same is true for every node

//inorder travrsal of bst and populate the tree in preorder 
